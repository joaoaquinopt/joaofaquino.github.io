...
//               !filtersVisible ? styles.contentNoSidebar : ""
//             }`}
//           >
//             {/* SIDEBAR - Filtros */}
//             {filtersVisible && (
...
//                       showTypeFilter ? "" : styles.collapsed
//                     }`}
//                   >
//                     <span>Tipo</span>
...
//                     className={`${styles.filterHeader} ${
//                       showBrandFilter ? "" : styles.collapsed
//                     }`}
//                   >
//                     <span>Marca</span>
//                     <ChevronDown className="w-4 h-4" />
...
//                     className={`${styles.filterHeader} ${
//                       showCategoryFilter ? "" : styles.collapsed
//                     }`}
//                   >
//                     <span>Categoria</span>
//                     <ChevronDown className="w-4 h-4" />
...
//                             {product.type === "affiliate" && product.link && (
//                               <div className={styles.productCta}>
//                                 <span>Ver produto</span>
//                                 <ArrowUpRight className={styles.productCtaIcon} />
//                               </div>
//                             )}
//                           </div>
//                         </div>
...
//                     // Se tiver link de afiliado, torna o card clicável
//                     return product.link ? (
//                       <a
//                         key={product.id}
//                         href={product.link}
